...
import { regimenDe } from "./catalogos.js";
...
export function revisar(negocio, ajustes, hoy, cartera) {
  ...
  const enMarcha = enMarchaSegunCartera(n, cartera);
  ...
  if (!n.ficha_completa) {
    ...
    if (!n.fecha_inicio) n.avisos.push(aviso("falta_fecha_inicio", "Sin la fecha en que se publicó no se puede medir el plazo"));
