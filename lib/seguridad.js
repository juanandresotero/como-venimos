...
export const ESTADOS = [
  { clave: "reservada", nombre: "Reservada", sub: "firmó la reserva" },
  { clave: "en_negociacion", nombre: "En negociación", sub: "hay una oferta" },
  { clave: "publicada", nombre: "Publicada", sub: "todavía no se movió" },
];
