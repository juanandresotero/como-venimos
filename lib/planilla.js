...
const COLUMNAS_NEGOCIOS = [
  ...
  { nombre: "Precio de cierre", valor: (n) => n.precio_operacion },
  { nombre: "Precio publicado", valor: (n) => n.precio_publicado },
  /* Cuanto bajaste del publicado para cerrar. En la planilla va como numero suelto —9,2— y no
     como fraccion, porque quien la abre en Excel quiere sumarlo y promediarlo, no dividirlo. */
  { nombre: "% que bajaste para cerrar", valor: (n) => (
    n.baja_sobre_publicado === null || n.baja_sobre_publicado === undefined
      ? null
      : Number((n.baja_sobre_publicado * 100).toFixed(2))) },
