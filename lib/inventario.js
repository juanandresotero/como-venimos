...
export const ESTADOS = [
  ...
  { clave: "malo", nombre: "Con problemas", texto: "" },
...
export function comoSeLee(item) {
  if (!item || item.estado === "no_tiene") return "";
...
export const TIPOS_DE_AMBIENTE = [
  ...
  { clave: "vacio", nombre: "Otro ambiente (vacío)", items: [] },
];
...
export function comoVa(inv) {
  ...
  const usados = items.filter((i) => i.estado !== "no_tiene");
  return {
