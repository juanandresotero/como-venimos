...
export const GRUPOS = {
  ...
  /* La app ya lo dio por caido y los numeros cambiaron: se avisa arriba, no al final. */
  se_cayo_solo: { nombre: "Negocios que di por caídos", orden: 2.6, urgente: true },
...
/* "¿Se vendio o se cayo?" tambien: sin contestarla, esa venta no suma en ningun lado. */
const ATRAVIESAN_FICHA_COMPLETA = new Set(
  ["revisar_puntas", "se_cayo_solo", "comision_absurda", "cerrar_negocio"]);
