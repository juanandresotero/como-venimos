...
export const GRUPOS = {
  ...
  /* Lo mismo otra vez: una suplencia no figura en ninguna otra pantalla salvo Cartera, y lo
     unico que hay que hacer es ponerle la fecha el dia que te la paguen. */
