...
/* Catastro separa los pedazos de la direccion CON COMAS. Si el usuario escribe una coma
   en el apartamento —"202,X"— la direccion queda con ocho pedazos en vez de siete y
   Catastro devuelve otro documento o un error. Se deja pasar solo letras y numeros, que es
   lo unico que puede ser una unidad o un bloque. */
...
export function papelesDeCatastro(padron, { apartamento = "", bloque = "" } = {}) {
  const unidad = soloLetrasYNumeros(apartamento);
