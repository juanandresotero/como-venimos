...
function volcarNegocioEnPropiedad(estado, negocio, cambios) {
  ...
  for (const [enElNegocio, enLaPropiedad] of Object.entries(COMPARTIDOS)) {
    ...
    // Si carga la fecha a mano, deja de ser la estimacion que puso el robot.
    if (enLaPropiedad === "fecha_captacion_real") paraLaPropiedad.fecha_captacion_estimada = false;
  }
